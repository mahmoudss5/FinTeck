...
| #   | Method | Endpoint                                          | Description                | Tested    | Notes |
| --- | ------ | ------------------------------------------------- | -------------------------- | ------    | ----- |
| 35  | POST   | `/support-ticket-responses/api`                   | Create response            | []        |       |
| 36  | GET    | `/support-ticket-responses/api/{responseId}`      | Get response by ID         | [ ]       |       |
| 37  | GET    | `/support-ticket-responses/api/ticket/{ticketId}` | Get responses by ticket ID | [ ]       |       |
| 38  | GET    | `/support-ticket-responses/api/sender/{senderId}` | Get responses by sender ID | [ ]       |       |
| 39  | DELETE | `/support-ticket-responses/api/{responseId}`      | Delete response            | [ ]       |       |
...
| Support Ticket          | 9          | 0      | 0       | 0      |
| Support Ticket Response | 5          | 0      | 0       | 0      |
| **TOTAL**               | **39**     | **0**  | **0**   | **0**  |
...
_Last Updated: 6 pm : January 30, 2026_
_Last Updated: 3 pm : January 30, 2026_
